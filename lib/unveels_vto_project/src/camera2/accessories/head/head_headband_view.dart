...
class HeadHeadbandView extends StatefulWidget {
  ...
  const HeadHeadbandView({super.key, this.webViewController});
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      var dataResponse = await productRepository.fetchProducts(
          fabric: headbandSelected == null
              ? null
              : getFabricByLabel(headbandList[headbandSelected!]),
        ...
        itemBuilder: (context, index) {
          return InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color:
                    headbandSelected == index ? const Color(0xffCA9C43) : null,
                borderRadius: BorderRadius.circular(16),
                border: Border.all(
